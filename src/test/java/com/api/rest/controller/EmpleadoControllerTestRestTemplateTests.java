...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //Vamos a utilizar un puerto aleatorio
public class EmpleadoControllerTestRestTemplateTests {
    ...
    void testGuardarEmpleado(){
        ...
        assertNotNull(empleadoCreado);// Empleado no es nulo
    ...
    void testEliminarEmpleado(){
        ...
        ResponseEntity<Void> exchange = testRestTemplate.exchange("http://localhost:8080/api/empleados/{id}", HttpMethod.DELETE,null,Void.class,pathVariables);//Eliminar empleado

        assertEquals(HttpStatus.OK,exchange.getStatusCode());
        assertFalse(exchange.hasBody());// No tengamos el cuerpo
